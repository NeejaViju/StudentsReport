...
default_tasks = {
    ...
    "Week10": ["Do Git CherryPicking","Create a summary report of Javascript V8 Engine","Create an Account in Twitch","Create your first React app"]
...
weeks_to_report = ["Week01", "Week02", "Week03", "Week04", "Week05", "Week06", "Week07", "Week08","Week09","Week10"]  # Add other weeks as needed
